...
with st.sidebar:
    st.image('pj8/Minhvuong.png', caption='Minh Vương M4U')
...
st.audio('pj8/Trucxinh.mp3',format='mp3')
st.title('MV yêu thích')
st.video('https://www.youtube.com/watch?v=EHASipZkZnk&list=RDEHASipZkZnk&start_radio=1&pp=ygURZW0gxqFpIGzDqm4gcGjhu5GgBwE%3D',format='mp4/video')
